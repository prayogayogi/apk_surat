  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12 mb-4">
        <h3 class="judul mt-4 h3 text-gray-800">Tambah Surat Keluar</h3>
        <?= form_open_multipart('surat/aksiTambahSuratKeluar'); ?>
        <div class="row mt-4">
          <div class="col">
          ...
          <div class="col">
            ...
            <div class="form-group">
              ...
              <a href="<?= base_url('surat/suratKeluar'); ?>" class="float-right btn btn-warning mr-2">Kembali</a>
            </div>
          </div>
        </div>
        <?= form_close(); ?>
